...
function GoodbyeMessage({ onComplete }) {
  ...
  return /* @__PURE__ */ jsx(ScrollingWelcome, { text: message, onComplete });
}
...
function SelectList({ items, onSelect, onBack, title, color = theme.purple, showBorder = true, showArtwork = false, showNumbers = true, enableSearch = false }) {
  ...
  const content = /* @__PURE__ */ jsxs(Box, { flexDirection: "column", children: [
    ...
    /* @__PURE__ */ jsx(Box, { marginTop: title ? 1 : 0, flexDirection: "column", children: visibleItems.map((item, idx) => {
  ...
  if (showArtwork) {
    ...
    return /* @__PURE__ */ jsxs(Box, { flexDirection: "row", children: [
      /* @__PURE__ */ jsxs(Box, { flexDirection: "column", marginRight: 2, width: artworkWidth, children: [
        /* @__PURE__ */ jsx(
          AnimeArtwork,
          {
  ...
  if (showBorder) {
    return /* @__PURE__ */ jsx(Box, { flexDirection: "column", borderStyle: "round", borderColor: color, paddingX: 1, paddingY: 1, children: content });
  }
  return content;
}
...
function App() {
  ...
  if (isExiting) {
    return /* @__PURE__ */ jsxs(Box, { flexDirection: "column", padding: 1, alignItems: "center", children: [
      /* @__PURE__ */ jsx(Banner, { phase: bannerPhase }),
      /* @__PURE__ */ jsx(Box, { marginTop: 2, justifyContent: "center", children: /* @__PURE__ */ jsx(GoodbyeMessage, { onComplete: () => process.exit(0) }) })
    ] });
  }
  return /* @__PURE__ */ jsxs(Box, { flexDirection: "column", padding: 1, alignItems: "center", children: [
    /* @__PURE__ */ jsx(Banner, { phase: bannerPhase }),
    showWelcome && screen === "main-menu" && /* @__PURE__ */ jsx(Box, { marginBottom: 1, justifyContent: "center", width: "100%", children: /* @__PURE__ */ jsx(
      ScrollingWelcome,
      {
    ...
    screen === "anime-select" && /* @__PURE__ */ jsx(
      SelectList,
      {
        items: animeItems,
